-- =====================================================
-- FINAL COURSE SERVICE SCHEMA MIGRATION
-- =====================================================
-- This migration provides the final, production-ready course service schema
-- with proper naming conventions, RLS policies, and functionality
...
CREATE INDEX idx_reviews_approved ON course_reviews(is_approved);

-- Course Progress indexes
CREATE INDEX idx_progress_user_course ON course_progress(user_id, course_id);
CREATE INDEX idx_progress_lesson ON course_progress(lesson_id);
CREATE INDEX idx_progress_completed ON course_progress(completed_at);

-- Course Wishlist indexes
CREATE INDEX idx_wishlist_user ON course_wishlist(user_id);
CREATE INDEX idx_wishlist_course ON course_wishlist(course_id);
...
CREATE INDEX idx_notifications_user ON course_notifications(user_id);
CREATE INDEX idx_notifications_course ON course_notifications(course_id);
CREATE INDEX idx_notifications_read ON course_notifications(is_read);
CREATE INDEX idx_notifications_type ON course_notifications(type);
